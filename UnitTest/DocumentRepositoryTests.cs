...
namespace UnitTest
{
    public class DocumentRepositoryTests
    {
        ...
        public async Task GetDocumentByIdAsync_Returns_Correct_Document()
        {
            ...
            {
                DocumentId = 1, DocumentTags = new List<DocumentTags> { new() { DocumentId = 1, TagId = 1 } },
        ...
        public async Task UpdateDocumentAsync_Updates_Document()
        {
            ...
            {
                DocumentId = 1, DocumentTags = new List<DocumentTags>{new() {DocumentId = 1, TagId = 1}}, AdditionalData =
